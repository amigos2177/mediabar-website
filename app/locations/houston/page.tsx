...
const industries = [
  { icon: '⛽', name: 'Energy & Oil & Gas', desc: '26 Fortune 500 headquarters including ExxonMobil, Phillips 66, and ConocoPhillips. The Energy Corridor is one of the highest concentrations of corporate HQs in the country.' },
  { icon: '🏥', name: 'Healthcare & Life Sciences', desc: 'The Texas Medical Center is the largest medical complex in the world, with over 100,000 employees across 60+ institutions. Demand for clinical, patient, and institutional video is constant.' },
  { icon: '🚀', name: 'Aerospace & NASA', desc: 'Johnson Space Center and a dense aerospace contractor ecosystem make Houston a hub for aerospace communications, mission documentation, and engineering video.' },
  { icon: '🚢', name: 'Manufacturing & Port', desc: 'The Port of Houston is the busiest in the country by foreign tonnage. Industrial video, safety training, and supply chain documentation for manufacturing is a core market here.' },
  { icon: '💼', name: 'Financial Services', desc: 'Houston\'s financial services sector grew 6.4% in 2024, driven by energy finance, commercial banking, and the expansion of regional and national institutions into the market.' },
  { icon: '🧬', name: 'Biotech & Research', desc: 'Over 1,100 biotech companies operate in the greater Houston area, anchored by TMC research institutions and a growing investment in life sciences infrastructure.' },
]

const locations = [
  { icon: '🌆', name: 'Downtown Houston Skyline', desc: 'One of the most dramatic skylines in the South — JPMorgan Chase Tower, Pennzoil Place, and the iconic neon-lit skyline for establishing shots and aerial work.' },
  { icon: '🏥', name: 'Texas Medical Center', desc: 'The world\'s largest medical complex. TMC\'s campus offers clinical, campus, and institutional environments for healthcare and life sciences content.' },
  { icon: '🚀', name: 'NASA Johnson Space Center', desc: 'Mission Control, the astronaut training facilities, and the Space Center campus — available for permitted shoots with advance coordination.' },
  { icon: '🚢', name: 'Port of Houston', desc: 'Industrial scale on the water. The Port\'s ship channel, terminals, and logistics infrastructure create a powerful visual environment for energy and supply chain content.' },
  { icon: '🌳', name: 'Hermann Park & Museum District', desc: 'The Houston Museum of Natural Science, the Museum of Fine Arts, and Hermann Park create a cultural corridor with diverse visual environments.' },
  { icon: '🛍️', name: 'The Galleria & Energy Corridor', desc: 'Houston\'s upscale commercial corridor — the Galleria area and the Energy Corridor along I-10 offer polished corporate and retail environments.' },
]
  ...
  return (
    <Layout>
      ...
      <section className="page-hero">
        <div className="hero-bg-text" aria-hidden="true">HOUSTON</div>
        <p className="hero-eyebrow">Houston Texas Video Production</p>
        <h1 className="hero-h1">Video Production <em>Houston</em></h1>
        <p className="hero-sub">From the energy corridors of the Galleria to the Texas Medical Center, Houston is one of the most commercially active cities in the country.</p>
        <div className="drive-badge">
          <span>3.5 hrs</span> from San Antonio · Day trips available
        </div>
      </section>
      ...
      <div className="section-wrap">
        <div className="section-inner">
          ...
          <h2 className="section-h2">Who We Shoot For in <em>Houston</em></h2>
        ...
        <div className="why-inner reveal">
          ...
          <div className="why-list">
            {[
              ...
              { title: 'Texas-Based, Texas-Focused', desc: 'We\'re three and a half hours down I-10. We travel without the overhead of national agencies — and it shows in the quote.' },
      ...
      <section className="cta-wrap">
        ...
        <h2 className="cta-h2">Shooting in <em>Houston?</em></h2>
