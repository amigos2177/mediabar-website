export const eventVideoFaqs = [
  ...
  {
    question: 'How many cameras will our event need?',
    answer:
  ...
  {
    question: 'Can you record clean speaker and room audio?',
    answer:
  ...
  {
    question: 'Can the event also be live streamed?',
    answer:
  ...
  {
    question: 'What can you deliver after the event?',
    answer:
  ...
  {
    question: 'How far in advance should we book an event video team?',
    answer:
  ...
  {
    question: 'Can you capture interviews during the event?',
    answer:
  ...
  {
    question: 'Can Media Bar provide event photography and video together?',
    answer:
  ...
  {
    question: 'Can you deliver a same-day or fast-turnaround event recap?',
    answer:
  ...
  {
    question: 'How much does event video production cost and how long does editing take?',
    answer:
