export const postProductionFaqs = [
  ...
  {
    question: 'What do you need before editing begins?',
    answer:
  ...
  {
    question: 'Can you provide captions and multiple formats?',
    answer:
  ...
  {
    question: 'How is post-production priced?',
    answer:
...
export const postProductionVideo = {
  id: '1077104073',
  title: '2025 Corporate Video Demo Reel',
  eyebrow: 'Featured Finish',
  heading: 'The Difference Is in the Decisions.',
  copy:
