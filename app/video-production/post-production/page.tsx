...
const useCases = [
  { icon: '✂️', title: 'Video Editing' },
  { icon: '🎨', title: 'Color Grading' },
  { icon: '🔊', title: 'Sound Design & Mix' },
  { icon: '✨', title: 'Motion Graphics' },
  { icon: '🎭', title: 'VFX & Cleanup' },
  { icon: '📦', title: 'Multi-Format Delivery' },
]

const processSteps = [
  { num: '01', title: 'Ingest & Organize', desc: 'We take in your footage and build a clean, organized edit project.', bullets: ['Footage ingest & backup', 'Transcoding if needed', 'Sync & organize', 'Assembly cut'] },
  { num: '02', title: 'Picture Edit', desc: 'Story-first editorial that serves the project\'s goals.', bullets: ['Rough cut review', 'Client feedback pass', 'Fine cut', 'Picture lock'] },
  { num: '03', title: 'Color & Sound', desc: 'Finishing that makes every frame and every sound count.', bullets: ['Color grade', 'Audio mix & EQ', 'Music & SFX', 'Motion graphics'] },
  { num: '04', title: 'Delivery', desc: 'Final files in every format you need, delivered on time.', bullets: ['Broadcast masters', 'Digital/web exports', 'Social media cuts', 'Closed captions'] },
]

const whyCards = [
  { icon: '🎬', title: 'Full In-House Pipeline', desc: 'Editorial, color, audio, and VFX all under one roof. No handoffs between vendors, no communication gaps, no timeline surprises.' },
  { icon: '🖥️', title: 'Professional Color Suite', desc: 'DaVinci Resolve color suite with calibrated reference monitors. Broadcast-accurate color for every deliverable.' },
  { icon: '🔊', title: 'Dedicated Audio Post', desc: 'Pro Tools audio post with experienced mixers. Dialogue cleanup, music bed, sound design, and final mix to broadcast spec.' },
  { icon: '📁', title: 'Bring Your Own Footage', desc: 'You don\'t have to shoot with us to work with our post team. We take in footage from any source and deliver professional results.' },
  { icon: '⚡', title: 'Fast Turnaround', desc: 'Simple editing projects can often be turned around in 48–72 hours. Complex finishing work follows a timeline we agree on before we start.' },
  { icon: '🔒', title: 'Secure Project Handling', desc: 'All footage is backed up to redundant drives on ingest. Project files are retained for 90 days after delivery in case revisions are needed.' },
]

const faqs = [
  { q: 'Can you edit footage that wasn\'t shot by your team?', a: 'Yes. Post-production-only projects are a significant part of our business. We work with footage from any camera system in any format. Just share your files via our secure transfer link and we\'ll review the material and provide a post-only quote.' },
  { q: 'What is your standard turnaround time for editing?', a: 'A simple 2–3 minute edit with basic color and audio typically takes 3–5 business days. A full corporate video or commercial with color grading, sound design, and motion graphics takes 10–15 business days. We\'ll give you a firm delivery date in your quote before any work begins.' },
  { q: 'What formats do you deliver in?', a: 'We deliver in any format required: H.264 or H.265 MP4 for digital/web, ProRes 422 or 4444 for broadcast and archival masters, MOV or MXF for specific broadcast specs, and platform-specific exports for YouTube, Vimeo, Instagram, and other social platforms. Closed caption files (SRT, VTT) are also available.' },
  { q: 'Do you do transcription and closed captioning?', a: 'Yes. We offer transcription and closed caption services as an add-on to any post project. We deliver SRT files that can be uploaded to any platform, or burned-in captions if that\'s your preference. Accuracy is verified by a human editor, not just AI auto-captions.' },
  { q: 'How many rounds of revisions are included?', a: 'Our standard packages include two rounds of revisions at picture cut stage and one round at final delivery. This covers the vast majority of projects. Additional revision rounds can be added — we\'ll discuss that during the proposal stage if your project scope requires it.' },
]
  ...
  return (
    <Layout>
      <style>{`
        ...
        .page-hero{position:relative;background:linear-gradient(to right,rgba(0,0,0,0.85),rgba(0,0,0,0.55)),url('/images/studio-4.jpg') center/cover no-repeat;padding:140px 64px 100px;overflow:hidden;border-bottom:1px solid #1a1a1a}
      ...
      <section className="page-hero">
        <div className="hero-bg-text" aria-hidden="true">POST</div>
        <div className="hero-inner">
          <div>
            <nav className="breadcrumb" aria-label="Breadcrumb">
              <Link href="/">Home</Link><span>/</span>
              <Link href="/video-production">Services</Link><span>/</span>
              <span style={{ color: '#AAAAAA' }}>Post Production</span>
            </nav>
            <p className="eyebrow">Post Production &amp; Finishing</p>
            <h1 className="page-h1"><em>Post Production</em>&amp; Editing</h1>
            <p className="hero-sub">Where good footage becomes great video. Full post-production services including editorial, color grading, audio mix, motion graphics, and multi-format delivery.</p>
          ...
          <div className="stat-card reveal">
            <div className="stat-item"><p className="stat-value">✓</p><p className="stat-label">Bring Your Own Footage</p></div>
            <div className="stat-item"><p className="stat-value">4K</p><p className="stat-label">Up To 4K Delivery</p></div>
            <div className="stat-item"><p className="stat-value">48h</p><p className="stat-label">Rush Delivery Available</p></div>
          </div>
        </div>
      </section>
        ...
        <div className="section">
          <div className="intro-grid">
            <div className="reveal">
              ...
              <h2 className="section-h2">Footage In, <em>Film Out</em></h2>
              <p className="body-text">Post-production is where the real storytelling happens. The best footage in the world is just raw material until a skilled editor, colorist, and audio engineer turn it into something that moves people. We've built a full post pipeline — editorial, color, sound, graphics, and delivery — all in-house.</p>
              <p className="body-text">You don't have to shoot with us to work with our post team. Bring us your footage from any source and we'll deliver broadcast-quality results on time.</p>
            </div>
            <div className="reveal">
        ...
        <div className="section">
          <div className="portfolio-header reveal">
            <div>
              ...
              <h2 className="section-h2" style={{ marginBottom: 0 }}>Post Production <em>Portfolio</em></h2>
            </div>
            <Link href="/work" className="link-arrow">View All Work →</Link>
          </div>
          <div className="portfolio-grid reveal">
            {[
              { id: '1180526566', label: 'Post Production' },
              { id: '1067207585', label: 'Post Production' },
              { id: '298056449', label: 'Post Production' },
              { id: '666115814', label: 'Post Production' },
            ].map((v) => (
              <div key={v.id}>
      ...
      <div className="why-wrap">
        <div className="why-inner">
          <div className="why-sticky reveal">
            ...
            <h2 className="section-h2">Why Clients Trust <em>Us</em> With Their Footage</h2>
          </div>
      ...
      <section className="cta-wrap">
        ...
        <h2 className="cta-h2">Ready To <em>Finish Strong?</em></h2>
        <p className="cta-sub">Send us your footage and let's talk about what we can build from it.</p>
