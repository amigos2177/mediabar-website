...
const useCases = [
  { icon: '🏠', title: 'Property Walkthroughs' },
  { icon: '🚁', title: 'Aerial Coverage' },
  { icon: '👤', title: 'Agent Branding Videos' },
  { icon: '🏗️', title: 'New Construction' },
  { icon: '🏢', title: 'Commercial Property' },
  { icon: '🏘️', title: 'Apartment Communities' },
]
...
const whyCards = [
  ...
  { icon: '🏆', title: 'Luxury to Entry-Level', desc: 'We produce for every price point — from entry-level residential to multi-million dollar luxury estates and large commercial properties. Consistent quality at every tier.' },
]
  ...
  return (
    <Layout>
      <style>{`
        ...
        .page-hero{position:relative;background:linear-gradient(to right,rgba(0,0,0,0.85),rgba(0,0,0,0.55)),url('/images/bts-3.jpg') center/cover no-repeat;padding:140px 64px 100px;overflow:hidden;border-bottom:1px solid #1a1a1a}
        ...
        <div className="hero-inner">
          <div>
            <nav className="breadcrumb" aria-label="Breadcrumb">
              ...
              <span style={{ color: '#888' }}>Real Estate Video</span>
            </nav>
        ...
        <div className="section">
          <div className="portfolio-header reveal">
            <div>
              ...
              <h2 className="section-h2" style={{ marginBottom: 0 }}>Real Estate <em>Portfolio</em></h2>
            </div>
            <Link href="/work" className="link-arrow">View All Work →</Link>
          </div>
          <div className="portfolio-grid-wide reveal">
            {[
              { id: '1138383811', label: 'Real Estate Video Production' },
              { id: '1180540292', label: 'Real Estate Video Production' },
            ].map((v) => (
              <div key={v.id}>
      ...
      <div className="why-wrap">
        <div className="why-inner">
          <div className="why-sticky reveal">
            ...
            <h2 className="section-h2">Why Agents &amp; Developers Choose <em>Us</em></h2>
          </div>
